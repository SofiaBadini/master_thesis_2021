...
project = "On the empirical identification of time preferences in discrete choice dynamic programming models"
...
latex_documents = [
    (
        ...
        """On the empirical identification of time preferences in discrete choice
        dynamic programming models. Documentation.""",
        "Sofia Badini",
        "manual",
    )
]
